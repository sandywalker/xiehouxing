{{-- <div class="share-bar">
	<a href="#" class="share-weibo share-icon" title="分享到微博"></a>
	
	<a href="#" class="share-weixin share-icon" data-trigger="hover" data-animation="pop" title="分享到微信"></a>
	<div class="webui-popover-content text-center">
         {!! QrCode::size(200)->generate(Request::url()) !!}
         <p>用微信扫一下！</p>
	</div>
	<div class="share-caption">分享到：</div>
</div> --}}
